  ...
  <div class="container">
    <div class="main-body">
      <div class="row gutters-sm">
        ...
        <div class="col-md-8">
          <SupplierInfo v-if="homePage"></SupplierInfo>
...
import SupplierLinks from '@/components/supplier/SupplierLinks.vue'
import SupplierInfo from '@/components/supplier/SupplierInfo.vue'

export default {
  name: "Supplier",
  components: {
    Navbar, SupplierUpdate, SupplierLinks, SupplierInfo
  },
  computed: {
    homePage() {
      return (this.$route.path === "/supplier")
    }
  }
}
</script>
