      ...
      <div class="modal-mask">
        <div class="modal-wrapper">
          <div class="modal-container" style="width: 400px">
            ...
            <div class="container">
              <button type="button" class="btn btn-primary mx-2" @click="addMedicine()">Add</button>
...
export default {
  ...
  methods: {
    loadMedicines() {
      MedicineService.newMedicine(this.pharmacyId)
          .then((response) => {
    ...
    addMedicine() {
      MedicineService.registerPharmacyMedicine(this.pharmacyId, this.medicineShow.id)
          .then((response) => {
            this.showOne = false;
            this.$toast.show('Medicine \'' + this.medicineShow.name + '\' added successfully!',{
              type: 'info',
              position: 'top',
              duration: 3000
            });
