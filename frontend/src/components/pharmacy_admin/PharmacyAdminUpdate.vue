    ...
    <div class="card-body">
      <div class="d-flex flex-column align-items-center text-center">
        ...
        <div class="mt-3">
          ...
          <button class="btn btn-outline-primary mx-2" data-bs-target="#edit-modal" data-bs-toggle="modal" v-on:click="edit">Edit</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" v-on:click="cancel" id="close-modal"></button>
        </div>
...
export default {
  name: "PharmacyAdminUpdate",
  methods: {
    saveChanges(event) {
      if (this.validate()) {
        PharmacyAdminService.updateUser(this.updated.id, this.updated)
        .then((response) => {
