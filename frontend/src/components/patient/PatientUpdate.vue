<template>
    ...
    <div class="card-body">
      <div class="d-flex flex-column align-items-center text-center">
        ...
        <div class="mt-3">
          ...
          <button class="btn btn-outline-primary mx-2" data-bs-target="#edit-modal-patient" data-bs-toggle="modal" v-on:click="edit">Edit</button>
          <button class="btn btn-outline-primary" data-bs-target="#change-password-modal-patient" data-bs-toggle="modal">Change password</button>
        </div>
      </div>
    </div>
  </div>

  <div class="modal" id="edit-modal-patient">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Update your data</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" v-on:click="cancel" id="close-modal-patient"></button>
        </div>
  ...
  <div class="modal" id="change-password-modal-patient">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
...
export default {
    ...
    methods: {
        saveChanges(event) {
            if (this.validate()) {
                PatientService.updatePatient(this.updated.id, this.updated)
                .then((response) => {
                    response.data.role = this.updated.role;
                    this.$store.commit('updateUser', response.data);
                });
                document.getElementById('close-modal-patient').click();
